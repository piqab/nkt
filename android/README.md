...
- Экран хоста (`ui/host/HostScreen.kt`) с боковым меню разделов и четыре
  раздела только для чтения: Обзор, Проблемы (с фильтром по важности),
  Интерфейсы, Журнал.

Не реализовано (следующие фазы): разделы с действиями (Services,
Containers, Users), мониторинг и уязвимости, Configs и Firewall,
терминал и сертификаты, управление хостами на уровне хаба
(add/edit/export/import), Topology, WebSocket-стриминг.
