...
curl -fsSLO https://github.com/piqab/nkt/releases/download/v1.8.40/nkt-linux-amd64
curl -fsSLO https://github.com/piqab/nkt/releases/download/v1.8.40/SHA256SUMS
